...
with st.expander("ℹ️ วิธีใช้งาน"):
    st.write("""
    1. อัปโหลดไฟล์ EXCEL RD03 ที่ได้จากระบบ TAMS (* ไม่ต้องแก้ไขหัวข้อไฟล์ excel *)
    2. โปรแกรมจะประมวลผลไฟล์ของคุณและแสดงรายละเอียดการประมวลผล
    3. ดาวน์โหลดไฟล์ EXCEL ที่ผ่านการคัดกรองเมื่อการประมวลผลเสร็จสิ้น
